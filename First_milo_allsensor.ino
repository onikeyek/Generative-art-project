// ================================================================
// MILO — Unified Firmware v1.1
// Sensors + TinyML Audio Classifier + Face State Engine
// With 3-second face hold timer for stability
// ================================================================
...
#define MOTION_TIMEOUT    15000

// ── Face hold timer ───────────────────────────────────────────────
#define FACE_HOLD_MS      3000
String lastFace = "content";
String pendingFace = "content";
...
// Returns the new face state based on all inputs
// ================================================================
...
void setup() {
  ...
  display.print("Milo waking up");
  display.setCursor(24, 36);
  display.print("Loading model...");
  display.display();

  Serial.println("Milo v1.1 starting...");
  ...
  Serial.println("Face | Temp | Humidity | MQ135 | PIR | kbd | noise | sil");
}
...
void loop() {
  ...
  if (newFace != lastFace) {
    ...
    // else: keep showing lastFace until hold time expires
  } else {
    faceHoldTime = millis(); // reset hold while same face continues
    renderFace(lastFace, temp);
  }
